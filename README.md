...
```bash
uvx cookiecutter https://github.com/qiqiqicheng/cookiecutter-pytorch-lightning.git
```
...
cookiecutter https://github.com/qiqiqicheng/cookiecutter-pytorch-lightning.git
```
